...
func Generate(input *GenerateInput) ([]byte, error) { //nolint:funlen // template data assembly
	...
	// Use the first URL to derive the extract command for the template.
	// All platforms are expected to use the same archive format.
	extractCmd := extractCommand(firstURL, &input.Tool, bins)
