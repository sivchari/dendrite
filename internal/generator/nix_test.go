	...
	}{
		{
			...
			input: GenerateInput{
				Tool: config.Tool{
					...
					Repo:          "cli",
					Version:       "v2.87.0",
					Asset:         map[string]string{"darwin": "gh_{version}_{os}_{arch}.tar.gz", "linux": "gh_{version}_{os}_{arch}.tar.gz"},
					Bins:          []string{"gh"},
					VersionPrefix: "v",
				},
				Lock: LockEntry{
		...
		},
		{
			...
			input: GenerateInput{
				Tool: config.Tool{
					...
					Repo:          "ripgrep",
					Version:       "14.1.0",
					Asset:         map[string]string{"darwin": "ripgrep-{version}-{arch}-{os}.tar.gz", "linux": "ripgrep-{version}-{arch}-{os}.tar.gz"},
					Bins:          []string{"rg"},
					VersionPrefix: "v",
				},
				Lock: LockEntry{
		...
		},
		{
			...
			input: GenerateInput{
				Tool: config.Tool{
					...
					Repo:          "aqua",
					Version:       "v2.39.0",
					Asset:         map[string]string{"darwin": "aqua_{os}_{arch}.tar.gz", "linux": "aqua_{os}_{arch}.tar.gz"},
					Bins:          []string{"aqua"},
					VersionPrefix: "v",
				},
				Lock: LockEntry{
		...
		},
		{
			...
			input: GenerateInput{
				Tool: config.Tool{
					...
					Repo:          "terraform",
					Version:       "v1.9.0",
					Asset:         map[string]string{"darwin": "terraform_{version}_{os}_{arch}.zip", "linux": "terraform_{version}_{os}_{arch}.zip"},
					Bins:          nil,
					VersionPrefix: "v",
				},
				Lock: LockEntry{
		...
		},
		{
			...
			input: GenerateInput{
				Tool: config.Tool{
					...
					Repo:          "fzf",
					Version:       "v0.55.0",
					Asset:         map[string]string{"darwin": "fzf-{version}-{os}_{arch}.tar.gz", "linux": "fzf-{version}-{os}_{arch}.tar.gz"},
					Bins:          []string{"fzf"},
					VersionPrefix: "v",
				},
				Lock: LockEntry{
		...
		},
		{
			...
			input: GenerateInput{
				Tool: config.Tool{
					...
					Repo:          "packer",
					Version:       "v1.11.0",
					Asset:         map[string]string{"darwin": "packer_{version}_{os}_{arch}.zip", "linux": "packer_{version}_{os}_{arch}.zip"},
					Bins:          []string{"packer"},
					VersionPrefix: "v",
				},
				Lock: LockEntry{
		...
		},
		{
			...
			input: GenerateInput{
				Tool: config.Tool{
					...
					Repo:          "go",
					Version:       "go1.26.0",
					Asset:         map[string]string{"darwin": "go{version}.darwin-arm64.tar.gz", "linux": "go{version}.darwin-arm64.tar.gz"},
		...
		},
		{
			...
			input: GenerateInput{
				Tool: config.Tool{
					...
					Repo:          "secretlint",
					Version:       "v10.2.0",
					Asset:         map[string]string{"darwin": "secretlint-{version}-{os}-{arch}", "linux": "secretlint-{version}-{os}-{arch}"},
		...
		},
		{
			...
			input: GenerateInput{
				Tool: config.Tool{
					...
					Repo:          "xo",
					Version:       "v0.1.1",
					Asset:         map[string]string{"darwin": "xo-{version}-{os}-{arch}.tar.bz2", "linux": "xo-{version}-{os}-{arch}.tar.bz2"},
					Bins:          []string{"xo"},
					VersionPrefix: "v",
				},
				Lock: LockEntry{
		...
		},
		{
			...
			input: GenerateInput{
				Tool: config.Tool{
					...
					Repo:          "ls-lint",
					Version:       "v2.3.1",
					Asset:         map[string]string{"darwin": "ls-lint-{os}-{arch}.tar.gz", "linux": "ls-lint-{os}-{arch}.tar.gz"},
					Bins:          []string{"ls-lint"},
					VersionPrefix: "",
		...
		},
		{
			...
			input: GenerateInput{
				Tool: config.Tool{
					...
					Repo:            "golangci-lint",
					Version:         "v2.11.4",
					Asset:           map[string]string{"darwin": "golangci-lint-{version}-{os}-{arch}.tar.gz", "linux": "golangci-lint-{version}-{os}-{arch}.tar.gz"},
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			input := GenerateInput{
				Tool: config.Tool{
					...
					Repo:          "repo",
					Version:       tt.version,
					Asset:         map[string]string{"darwin": "tool.tar.gz", "linux": "tool.tar.gz"},
					Bins:          []string{"tool"},
					VersionPrefix: "v",
				},
				Lock: LockEntry{
