...
func generateFromConfigAndLock(t *testing.T, configPath, lockPath, outDir string) {
	t.Helper()
	...
	for i := range cfg.Tools {
		...
		if len(locks) == 0 {
			t.Fatalf("no lock entries found for %s", name)
		}
...
`
	...
	lockContent := `# Code generated by dendrite; DO NOT EDIT.
tools:
    - name: cli/cli@v2.87.0
      assets:
        darwin_arm64:
        ...
        linux_amd64:
            ...
            sha256: "sha256-abc123fakehashGHLinux="
    - name: BurntSushi/ripgrep@14.1.0
      assets:
        darwin_arm64:
        ...
        linux_amd64:
            url: "https://github.com/BurntSushi/ripgrep/releases/download/14.1.0/ripgrep-14.1.0-x86_64-linux.tar.gz"
            sha256: "sha256-xyz789fakehashRGLinux="
`

	writeFile(t, configPath, configContent)
	writeFile(t, lockPath, lockContent)

	generateFromConfigAndLock(t, configPath, lockPath, outDir)
...
func TestE2E_LockFileHeader(t *testing.T) {
	...
	if !strings.HasPrefix(string(content), "# Code generated by dendrite; DO NOT EDIT.") {
